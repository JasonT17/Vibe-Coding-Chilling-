      ...
      <div className="border-b border-green-600">
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-xl font-bold">W's Dashboard</h1>
              <p className="text-xs text-green-200">Hệ thống quản lý tài chính</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <div className="relative">
              <input
                ...
                className="pl-10 pr-4 py-2 rounded-lg bg-green-600 text-white placeholder-green-200 focus:outline-none focus:ring-2 focus:ring-green-400 w-64"
              />
      ...
      <nav className="container mx-auto px-4">
        <ul className="flex space-x-1 overflow-x-auto scrollbar-hide">
          {navItems.map((item, index) => (
            <li key={index}>
              <button
                className={`px-4 py-3 text-sm font-medium whitespace-nowrap hover:bg-green-600 transition-colors ${
